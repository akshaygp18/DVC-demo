...
def main(config_path, params_path):
    ...
    train_df = train_df['fixed acidity;volatile acidity;citric acid;residual sugar;chlorides;free sulfur dioxide;total sulfur dioxide;density;pH;sulphates;alcohol;quality'].str.split(';', expand=True)
